...
class DefaultRouteRepository(
    ...
    override suspend fun getGraphPath(from: String, to: String): Result<Route> {
    ...
    override suspend fun getRouteToNextClass(from: String): Result<Route> {
    ...
    override suspend fun getRouteToClass(classId: String, from: String): Result<Route> {
    ...
    private suspend fun buildRouteFromNextClassFallback(from: String): Result<Route> {
