...
import com.uniandes.interactivemapuniandes.app.AppContainer
import com.uniandes.interactivemapuniandes.core.network.RetrofitInstance
import com.uniandes.interactivemapuniandes.data.routing.local.CachedRoute
import com.uniandes.interactivemapuniandes.data.routing.local.OfflineRouteCache
import com.uniandes.interactivemapuniandes.data.routing.local.RouteHistoryStore
...
import com.uniandes.interactivemapuniandes.core.network.NetworkMonitor
import com.uniandes.interactivemapuniandes.core.common.NextClassNotifier
import com.uniandes.interactivemapuniandes.core.telemetry.Telemetry
import com.uniandes.interactivemapuniandes.core.navigation.setupNavigation
import com.uniandes.interactivemapuniandes.ui.auth.LoginActivity
import com.uniandes.interactivemapuniandes.ui.home.HomeViewModel
import com.uniandes.interactivemapuniandes.ui.search.SearchActivity
import com.uniandes.interactivemapuniandes.ui.routing.RouteActivity
...
class HomeActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private lateinit var routeUseCases: RouteUseCases
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        routeUseCases = AppContainer.routeUseCases()
        homeViewModel = HomeViewModel(routeUseCases)
        observeUiState()
    ...
    private fun fetchRouteFromBackend(fromNode: String, toNode: String) {
        lifecycleScope.launch {
            routeUseCases.getGraphRoute(fromNode, toNode).fold(
                onSuccess = { route ->
    ...
    private fun saveRouteForOffline(route: Route) {
