...
class ScheduleActivity : AppCompatActivity() {
    ...
    private fun createScheduleViewModel(): ScheduleViewModel {
        return ScheduleViewModel(AppContainer.scheduleUseCases(applicationContext))
    }

    private fun renderScheduleClasses(selectedDate: LocalDate, classes: List<ScheduleClass>) {
