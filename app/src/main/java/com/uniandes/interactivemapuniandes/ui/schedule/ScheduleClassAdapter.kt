...
class ScheduleClassAdapter(
    private var items: List<ScheduleClass> = emptyList()
    ...
    fun updateItems(newItems: List<ScheduleClass>) {
        items = newItems
        notifyDataSetChanged()
    }

    private fun buildClassCode(scheduleClass: ScheduleClass): String {
    ...
    private fun buildLocation(scheduleClass: ScheduleClass): String {
        return listOfNotNull(
    ...
    private fun ScheduleClass.formatTimeRange(): String {
