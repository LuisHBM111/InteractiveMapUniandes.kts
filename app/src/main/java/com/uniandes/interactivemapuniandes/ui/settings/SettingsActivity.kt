package com.uniandes.interactivemapuniandes.ui.settings
...
import com.uniandes.interactivemapuniandes.data.user.repository.PreferencesRepository
...
import com.uniandes.interactivemapuniandes.ui.search.OfflineMapsActivity
        ...
        lifecycleScope.launch {
            try {
                RetrofitInstance.meApi.updateProfile(
                    com.uniandes.interactivemapuniandes.data.user.dto.UpdateProfileBody(profileImage = photoUrl)
                )
            } catch (e: Exception) {
